...
namespace Sparta2ndTeam_TeamProject
{
    internal class GameManager
    {
        ...
        private void InitializeGame()
        {
            ...
            // 몬스터 드랍 아이템 인덱스 10~ 
            items.Add(new Item("작은 혈석", "몬스터에게서 떨어져 나온 의문의 혈석입니다.(마나 15만큼 회복)", 0, 0, 0, 15, 1500, ItemType.MONSTER_DROP));
            items.Add(new Item("거대한 혈석", "몬스터에게서 떨어져 나온 의문의 혈석입니다.(마나 30만큼 회복)", 0, 0, 0, 30, 3000, ItemType.MONSTER_DROP));
