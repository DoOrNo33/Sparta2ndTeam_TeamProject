...
namespace Sparta2ndTeam_TeamProject
{
    internal class GameManager
    {
        ...
        private void InitializeGame()
        {
            ...
            items.Add(new Item("수련자 갑옷", "수련에 도움을 주는 갑옷입니다.", 0, 5, 0, 1000, ItemType.ARMOR,false,true));
            ...
            items.Add(new Item("청동 도끼", "어디선가 사용됐던거 같은 도끼입니다.", 5, 0, 0, 1500, ItemType.WEAPON,false,true));
